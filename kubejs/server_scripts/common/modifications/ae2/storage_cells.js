ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.draco_infusion(id(`singularity_crafting_storage`))
        .itemInputs('3x megacells:256m_crafting_storage','8x gtceu:double_netherite_certus_quartz_skystone_alloy_plate','8x kubejs:hellish_star','8x gtceu:quantum_star',
