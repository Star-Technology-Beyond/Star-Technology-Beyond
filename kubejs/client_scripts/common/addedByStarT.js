global.addedByStarT = {
    machines: [
        ...
        'advanced_synthesis_plant', 'component_part_hub', 'nyinsane_plasma_turbine', 'ulv_barrel', 'ulv_stone_barrel', 'ulv_advanced_composter'
    ],
    isCore: [
    ...
    subBatch: [
        'industrial_barrel', 'component_part_hub'
    ],
    pocBatch: [
